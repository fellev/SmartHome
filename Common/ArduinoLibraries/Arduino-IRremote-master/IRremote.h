...
//------------------------------------------------------------------------------
// Include for project config file
//
#include "IRconfig.h"
...
#       if SEND_TADIRAN_MULTI
            void  sendSection    (unsigned long long data, byte nbits);
            void  sendTadiarMulti(unsigned long long *p_sec1, byte sec1_nbits, unsigned long *p_sec2, byte sec2_nbits);
#       endif            
} ;
