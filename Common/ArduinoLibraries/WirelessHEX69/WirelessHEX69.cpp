...
void CheckForWirelessHEX(RFM69 radio, SPIFlashA flash, boolean DEBUG, byte LEDpin)
{
...
#ifdef SHIFTCHANNEL
boolean HandleWirelessHEXDataWrapper(RFM69 radio, byte remoteID, SPIFlashA flash, boolean DEBUG, byte LEDpin) {
...
boolean HandleWirelessHEXData(RFM69 radio, byte remoteID, SPIFlashA flash, boolean DEBUG, byte LEDpin) {
  long now=0;
  uint16_t tmp,seq=0;
  char buffer[16];
