...
void CheckForWirelessHEX(RFM69 radio, SPIFlashA flash, boolean DEBUG=false, byte LEDpin=LED);
void resetUsingWatchdog(boolean DEBUG=false);

boolean HandleWirelessHEXData(RFM69 radio, byte remoteID, SPIFlashA flash, boolean DEBUG=false, byte LEDpin=LED);
#ifdef SHIFTCHANNEL
boolean HandleWirelessHEXDataWrapper(RFM69 radio, byte remoteID, SPIFlashA flash, boolean DEBUG=false, byte LEDpin=LED);
#endif
