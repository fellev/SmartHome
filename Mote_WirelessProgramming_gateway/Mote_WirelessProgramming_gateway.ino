...
#include <SPI.h>
#include <SPIFlashA.h>      //get it here: https://www.github.com/lowpowerlab/spiflash
...
#define ENCRYPTKEY    ")nXLceHCQkaU{-5@" //"sampleEncryptKey" //")nXLceHCQkaU{-5@" //(16 bytes of your choice - keep the same on all encrypted nodes)
